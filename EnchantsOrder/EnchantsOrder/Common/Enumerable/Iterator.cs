...
{
    /// <summary>
    /// Provides a set of <see langword="static"/> (Shared in Visual Basic) methods for querying objects that implement <see cref="IEnumerable{T}"/>.
    /// </summary>
    internal static partial class Enumerable
    {
        ...
        internal abstract class Iterator<TSource> : IEnumerable<TSource>, IEnumerator<TSource>
        {
            ...
            {
                Iterator<TSource> enumerator = _state == 0 && _threadId == Thread.CurrentThread.ManagedThreadId ? this : Clone();
                enumerator._state = 1;
                return enumerator;
            }
